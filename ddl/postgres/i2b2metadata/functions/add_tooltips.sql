-- Function to load tooltips/hovers and definitions from comma-separated file 
-- with concept path in the first column and the tooltip/definition in the second.(non-Across Trials only)

CREATE FUNCTION add_tooltips(IN filename varchar, IN add_frontslashes bool, IN add_endslashes bool)
